    ...
    return (
      <>
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "1.15rem", margin: "0 0 0.75rem", color: "#fff" }}>
              Help us keep Scrapyards.io free
            </h2>
            <p id="cookie-modal-desc" style={{ lineHeight: 1.65, margin: "0 0 1.5rem", color: "#d4d4d2", fontSize: "0.9rem" }}>
              Scrapyards.io is free because of ads. Help us keep prices fresh by accepting cookies.{" "}
